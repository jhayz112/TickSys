            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tickets.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="contact" class="col-md-4 col-form-label text-md-right">@lang('Contact')</label>

                            <div class="col-md-6">
                                <textarea class="form-control @error('contact') is-invalid @enderror" id="contact" name="contact" rows="1" required>{{ old('contact') }}</textarea>
                                @error('contact')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="escalation" class="col-md-4 col-form-label text-md-right">@lang('Escalation Subject')</label>

                            <div class="col-md-6">
                                <textarea class="form-control @error('escalation') is-invalid @enderror" id="escalation" name="escalation" rows="1" required>{{ old('escalation') }}</textarea>
                                @error('escalation')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="site" class="col-md-4 col-form-label text-md-right">@lang('Site Url')</label>

                            <div class="col-md-6">
                                <textarea class="form-control @error('site') is-invalid @enderror" id="site" name="site" rows="1" required>{{ old('site') }}</textarea>
                                @error('site')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-md-4 col-form-label text-md-right">@lang('Due date of Request to be finished')</label>

                            <div class="col-md-6">
                                <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date" required>{{ old('date') }}</textarea>
                                @error('date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td width="30%"><input type="file" name="file" accept=".pdf, .docx, "></td>
                    </tr>
                </table>
            </div>
...
Dropzone.options.attachmentsDropzone = {
    ...
    success: function (file, response) {
      ...
      uploadedAttachmentsMap[file.name] = file.name
    },
